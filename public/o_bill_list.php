                ...
                <table class="table  table-responsive table-bordered table-striped fs--1 mb-0 table-hover" id="myTable">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="overflow-wrap: break-word;" scope="col" width="4%">Print Bill</th>
                    ...
                    <tbody>
                        ...
                        $todayd = date('Y-m-d');
                        $sql = "SELECT * FROM `op_bill`  "; // WHERE rdate = '$todayd' 
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td style="overflow-wrap: break-word;">
                                        ...
                                        <form action="o_bill_generate_edit.php" method="POST">
                                            <input type="hidden" name="id" value="<?php echo $row['pid']; ?>">
                                    ...
                                    <td style="overflow-wrap: break-word;">
                                        ...
                                        <form action="o_bill_print.php" method="POST">
                                            <input type="hidden" name="id" value="<?php echo $row['pid']; ?>">
            ...
            <div class="modal-content position-relative">
                ...
                <div class="modal-body p-0">
                    <div class="rounded-top-lg py-3 ps-4 pe-6 bg-light">
                        <h4 class="mb-1" style=" text-transform:capitalize;" id="modalExampleDemoLabel">Patient Bill/cash Memo details </h4>
                    </div>
                    <div class="p-4 pb-0">
                        ...
                        <table style="width: 100%;" class="mb-3" class="table table-borderless">
                            <tbody>
                                ...
                                <tr>
                                    <td style="width: 30.9714%;">Bill Generated On:</td>
                                    <td style="width: 2%;">:<br></td>
                                    <td style="width: 66.912%;"><?php if (isset($_POST['billview'])) {
                                ...
                                <tr>
                                    <td style="width: 30.9714%;">Operation Date:</td>
                                    <td style="width: 2%;">:<br></td>
                                    <td style="width: 66.912%;"><?php if (isset($_POST['billview'])) {
                                                                    echo $details['opon'];
                                                                } ?></td>
                                ...
                                <tr>
                                    <td style="width: 30.9714%;">Bed Charges:</td>
                                    <td style="width: 2%;">:<br></td>
                                    <td style="width: 66.912%;"><?php if (isset($_POST['billview'])) {
                                                                    echo $details['bed'];
                                                                } ?></td>
                                ...
                                <tr>
                                    <td style="width: 30.9714%;">Operation Theater Charges:</td>
                                    <td style="width: 2%;">:<br></td>
                                    <td style="width: 66.912%;"><?php if (isset($_POST['billview'])) {
                                                                    echo $details['ot'];
                                                                } ?></td>
                                ...
                                <tr>
                                    <td style="width: 30.9714%;">Surgeon Charges:</td>
                                    <td style="width: 2%;">:<br></td>
                                    <td style="width: 66.912%;"><?php if (isset($_POST['billview'])) {
                                                                    echo $details['surgeon'];
                                                                } ?></td>
                                </tr>
                                <tr>
                                    <td style="width: 30.9714%;">Anesthetic Charges:</td>
                                    <td style="width: 2%;">:<br></td>
                                    <td style="width: 66.912%;"><?php if (isset($_POST['billview'])) {
                                                                    echo $details['anesthetic'];
                                                                } ?></td>
                                </tr>
                                <tr>
                                    <td style="width: 30.9714%;">Assistant Charges:</td>
                                    <td style="width: 2%;">:<br></td>
                                    <td style="width: 66.912%;"><?php if (isset($_POST['billview'])) {
                                                                    echo $details['assistant'];
                                                                } ?></td>
                                </tr>
                                <tr>
                                    <td style="width: 30.9714%;">Laurette Cassette:</td>
                                    <td style="width: 2%;">:<br></td>
                                    <td style="width: 66.912%;"><?php if (isset($_POST['billview'])) {
                                                                    echo $details['lauca'];
                                                                } ?></td>
                                ...
                                <tr>
                                    <td style="width: 30.9714%;">Laurette Expenses:</td>
                                    <td style="width: 2%;">:<br></td>
                                    <td style="width: 66.912%;"><?php if (isset($_POST['billview'])) {
                                                                    echo $details['lauex'];
                                                                } ?></td>
                                ...
                                <tr>
                                    <td style="width: 30.9714%;">IOL work up:</td>
                                    <td style="width: 2%;">:<br></td>
                                    <td style="width: 66.912%;"><?php if (isset($_POST['billview'])) {
                                                                    echo $details['iolworkup'];
                                                                } ?></td>
                                </tr>
                                <tr>
                                    <td style="width: 30.9714%;">Medicine & Consumables:</td>
                                    <td style="width: 2%;">:<br></td>
                                    <td style="width: 66.912%;"><?php if (isset($_POST['billview'])) {
                                                                    echo $details['medicine'];
                                                                } ?></td>
                                </tr>
                                <tr>
                                    <td style="width: 30.9714%;">Intra Ocular Lens Charges:</td>
                                    <td style="width: 2%;">:<br></td>
                                    <td style="width: 66.912%;"><?php if (isset($_POST['billview'])) {
                                                                    echo $details['intra'];
                                                                } ?></td>
