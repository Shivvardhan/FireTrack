...
?>
    ...
    <div class="card mb-3">
        ...
        <div class="card-body position-relative">
            <div class="row">
                <div class="col-lg-8">
                    <h3>Create Patient Discharge Paper</h3>
                        ...
                        <form action="" method="POST">
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" id="i1" required name="diagnosis">
                                </div>
                                <div class="col-12">
                                    <label for="i2" class="form-label">Surgery Procedure</label>
                                    <input type="text" class="form-control" id="i2" required name="procedure">
                                </div>
                                ...
                                <div class="row gx-3 gy-2 align-items-center">
                                    <div class="col-auto">
                                        ...
                                        <input type="date" class="form-control" id="i3" required name="doa">
                                    </div>
                                    <div class="col-sm-2">
                                        <label for="i4" class="form-label">Time</label>
                                        <input type="time" class="form-control" id="i4" required name="t">
                                    </div>
                                    <div class="col-auto">
                                        <label for="i5" class="form-label">DOS (Date of Surgery)</label>
                                        <input type="date" class="form-control" id="i5" required name="dos">
                                    </div>
                                    <div class="col-auto">
                                        <label for="i6" class="form-label">DOD (Date of Discharge)</label>
                                        <input type="date" class="form-control" id="i6" required name="dod">
                                    </div>
                                    <div class="col-sm-2">
                                        <label for="i7" class="form-label">Time</label>
                                        <input type="time" class="form-control" id="i7" required name="tt">
                                    </div>
                                ...
                                <div class="col-12">
                                    <input class="btn btn-primary" type="submit" value="Create Discharge Papers" name="submit">
                                </div>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO `op_discharge`(`pid`, `diagnosis`, `surgeryprocedure`, `doa`, `doatime`, `dos`, `dod`, `dodtime`) VALUES ('$id','$diagnosis','$procedure','$doa','$t','$dos','$dod','$tt')";
    ...
    ?>
            <script>
                swal({
                    title: "Discharge Papers Generated Successfully",
