...
?>
                        ...
                        <form action="" method="POST">
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <input type="date" class="form-control" id="i1" required name="operationon" value="<?php echo $details['opon'] ?>">
                                </div>
                                <div class="col-md-6">
                                    <label for="i2" class="form-label">Bed Charges</label>
                                    <input type="number" class="form-control" id="i2" name="bed" value="<?php echo $details['bed'] ?>">
                                </div>
                                <div class="col-md-6">
                                    <label for="i3" class="form-label">Operation Theater Charges</label>
                                    <input type="number" class="form-control" id="i3" name="ot" value="<?php echo $details['ot'] ?>">
                                </div>
                                <div class="col-md-6">
                                    <label for="i4" class="form-label">Surgeon Charges</label>
                                    <input type="number" class="form-control" id="i4" name="surgeon" value="<?php echo $details['surgeon'] ?>">
                                </div>
                                <div class="col-md-6">
                                    <label for="i5" class="form-label">Anesthetic Charges</label>
                                    <input type="number" class="form-control" id="i5" name="anesthetic" value="<?php echo $details['anesthetic'] ?>">
                                </div>
                                <div class="col-md-6">
                                    <label for="i6" class="form-label">Assistant Charges</label>
                                    <input type="number" class="form-control" id="i6" name="assistant" value="<?php echo $details['assistant'] ?>">
                                </div>
                                <div class="col-md-6">
                                    <label for="i7" class="form-label">Laurette Cassette</label>
                                    <input type="number" class="form-control" id="i7" name="laurettecassette" value="<?php echo $details['lauca'] ?>">
                                </div>
                                <div class="col-md-6">
                                    <label for="i8" class="form-label">Laurette Expenses</label>
                                    <input type="number" class="form-control" id="i8" name="lauretteexpenses" value="<?php echo $details['lauex'] ?>">
                                </div>
                                <div class="col-md-6">
                                    <label for="i9" class="form-label">IOL work up</label>
                                    <input type="number" class="form-control" id="i9" name="iol" value="<?php echo $details['iolworkup'] ?>">
                                </div>
                                <div class="col-md-6">
                                    <label for="i10" class="form-label">Medicine & Consumables</label>
                                    <input type="number" class="form-control" id="i10" name="med" value="<?php echo $details['medicine'] ?>">
                                </div>
                                <div class="col-md-6">
                                    <label for="i11" class="form-label">Intra Ocular Lens Charges</label>
                                    <input type="number" class="form-control" id="i11"  name="intra" value="<?php echo $details['intra'] ?>">
                                </div>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "UPDATE `op_bill` SET `opon`='$operationon',`bed`='$bed',`ot`='$ot',`anesthetic`='$anesthetic',`surgeon`='$surgeon',`assistant`='$assistant',`laurettecassette`='$laurettecassette',`lauretteexpenses`='$lauretteexpenses',`iolworkup`='$iol',`medicine`='$med',`intra`='$intra' ,`total`='$total'  WHERE `pid`='$id'";
    ...
    ?>
            <script>
                swal({
                    title: "Cash/Bill Memo ",
                    text: "Changes have been Saved Sccessfully",
                    icon: "success",
                    button: "Close",
                }).then(function() {
